...
class keepalived (
  ...
  $dev_packages              = $keepalived::params::os_dev_packages,
  $dev_ensure                = $keepalived::params::dev_ensure,
  $build_options             = $keepalived::params::os_build_options,
  $firewall_ports            = $keepalived::params::firewall_ports,
  $config_dir                = $keepalived::params::os_config_dir,
  $config_file               = $keepalived::params::os_config_file,
  ...
  $build_package_init_script = $keepalived::params::os_build_package_init_script,
  $init_script               = $keepalived::params::os_init_script,
  $run_level_script          = $keepalived::params::os_run_level_script,
